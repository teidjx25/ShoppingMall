					...
					<div id="main">
						...
						<!-- Post -->
							...
							<section class="post">
								...
								<form method="post" action="productUpdate" id="frm" enctype="multipart/form-data">
										<input type="hidden" name="pId" value="${product.pId }">
										<input type="hidden" value="${product.bimg }" name="olduploadFile" id="olduploadFile">
								
									<div class="row gtr-uniform">
										
										<div class="col-6 col-12">
											상품 이름 : <input type="text" placeholder="상품을 입력하세요" value="${product.pName }" name="pName" id="pName" required/>
										</div>

										<div class="col-6 col-12-xsmall">
											상품의 가격 : <input type="number" class="mobile" min="0"  value="${product.pPrice }"name="pPrice" id="pPrice"  required>
										</div>

										<div class="col-6 col-12">
											판매자 이름 : <input type="text" placeholder="이름"  value="${product.maker }" name="maker" id="maker" readonly/>
										</div>
										<br>
										...
										<div class="major">
										상품의 재고 : 
										<input type="number" class="mobile" min="0" value="${product.pQTY }"name="pQTY"  id="pQTY" required>
										<hr>
										</div>
										...
										<div class="col-12">
											...
											<textarea placeholder="추천문구를 입력하세요" rows="6" name="recomendC" id="recomendC" required>${product.recomendC }</textarea>
										
										</div>
										<div class="col-12">
										소개글 : 
											<textarea placeholder="내용을 입력하세요" rows="6" name="pContent" id="pContent" required>${product.pContent }</textarea>
