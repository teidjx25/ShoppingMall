							...
							<section class="post">
								<header class="major">
									...
									<div class="row gtr-uniform">
										...
										<!-- Break -->
										<div class="col-12">
										<c:if test="${request.requestImg ne null }">
											<img src="/shoppingmall/resources/requestImg/${request.requestImg }" alt="문의사진" width="400"/>
										</c:if>
											<h3>내용 :</h3> ${request.contents}
											 <hr>
										</div>
										<!-- Break -->
										<ul class="actions small">
											<li><a href="/shoppingmall/productQuestion?pId=${request.bnum}" class="button primary small">목록</a></li>
											<li><a href="/shoppingmall/question/questionReply?qnum=${request.qnum}" class="button primary small">답글</a></li>
										<c:if test="${sessionScope.sessid eq request.name}">
										...
										<c:if test="${sessionScope.auth eq 2}">	
											<li><a href="/shoppingmall/question/questionAdminDelete?qnum=${request.qnum}&pId=${request.bnum}&state=2" class="button primary small">글 비공개</a></li>
											<li><a href="/shoppingmall/question/questionAdminDelete?qnum=${request.qnum}&pId=${request.bnum}&state=0" class="button primary small">글 공개</a></li>
										</c:if>
										</c:if>
